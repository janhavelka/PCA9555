...
| `config` | `read` | Read configuration registers. | `PASS` | `N/A` | `prompt` | 0.00s |  |
| `dirin 0x0F0F confirm` | `direction` | Configure masked pins as inputs. | `PASS` | `N/A` | `prompt` | 0.01s | Dynamic CLI command matched the unsafe output-control allowlist and requires opt-in. |
| `config` | `read` | Read configuration registers. | `PASS` | `N/A` | `prompt` | 0.00s |  |
...
| `health` | `health` | Capture driver health before stress. | `PASS` | `N/A` | `prompt` | 0.00s | Historical last-error fields may be nonzero; current READY state is the key gate. |
| `soak:aggregate` | `soak` | Aggregate statistics for soak. | `PASS` | `N/A` | `duration_limit` | 14400.01s | Generated by bounded repeated-command runner. |

## Aggregate Timing

| Label | Completed | Failures | Serial Reopens | Min | Mean | Max | Effective Hz | Stop Reason |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `soak` | 13694 | 0 | 119 | 0.000s | 0.002s | 0.032s | 0.951 | `duration_limit` |

## Evidence Excerpts

## Artifacts

- Serial transcript: `hil_logs\full_function_4h_20260624_segmented\i2c_20260624_140929\serial_transcript.txt`
- Operator checklist: `hil_logs\full_function_4h_20260624_segmented\i2c_20260624_140929\operator_checklist.md`
- Machine summary: `hil_logs\full_function_4h_20260624_segmented\i2c_20260624_140929\summary.json`
