...
| `dirin 0xFFFF confirm` | `direction` | Restore-safe-state command after `stress_mix 100 confirm`. | `PASS` | `N/A` | `prompt` | 0.01s | Automatic recovery command from HIL metadata. Restores all pins to input; output-to-input changes can trigger PCA9555 INT behavior. |
...
- Serial transcript: `hil_logs\restore_20260624\i2c_20260624_130104\serial_transcript.txt`
- Operator checklist: `hil_logs\restore_20260624\i2c_20260624_130104\operator_checklist.md`
- Machine summary: `hil_logs\restore_20260624\i2c_20260624_130104\summary.json`
