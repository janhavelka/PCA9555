...
Version 3.0.2 is a pre-production candidate. Native tests and compile checks are
...
track a moving branch. Version 3.0.2 can be pinned as:

```ini
lib_deps =
  https://github.com/janhavelka/PCA9555.git#v3.0.2
```
