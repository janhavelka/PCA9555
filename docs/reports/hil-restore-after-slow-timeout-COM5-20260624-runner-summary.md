...
| `stress 10` | `stress` | Run bounded read-only input stress using the CLI async stress command. | `PASS` | `N/A` | `prompt` | 0.00s | This repeatedly reads inputs and clears PCA9555 interrupt state. |
...
| `stress 1000` | `stress` | Longer read-only stress soak. | `PASS` | `N/A` | `prompt` | 0.30s | Longer soak is optional and still clears input interrupt state. |
...
| `soak:aggregate` | `soak` | Aggregate statistics for soak. | `PASS` | `N/A` | `command_limit` | 0.09s | Generated by bounded repeated-command runner. |

## Aggregate Timing

| Label | Completed | Failures | Serial Reopens | Min | Mean | Max | Effective Hz | Stop Reason |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `soak` | 2 | 0 | 0 | 0.000s | 0.000s | 0.000s | 21.277 | `command_limit` |

## Evidence Excerpts

## Artifacts

- Serial transcript: `hil_logs\restore_after_slow_timeout_20260624\i2c_20260624_140844\serial_transcript.txt`
- Operator checklist: `hil_logs\restore_after_slow_timeout_20260624\i2c_20260624_140844\operator_checklist.md`
- Machine summary: `hil_logs\restore_after_slow_timeout_20260624\i2c_20260624_140844\summary.json`
